...
class SignUp extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    if (this.validation()) {
      this.props.signup(
        this.state.activeItem.first_name,
        this.state.activeItem.last_name,
        this.state.activeItem.email,
        this.state.activeItem.year,
        this.state.activeItem.password,
        this.state.activeItem.re_password
      );
  ...
  validation = () => {
    ...
    if (
      ...
      typeof activeItem["password1"] !== "undefined"
    ) {
